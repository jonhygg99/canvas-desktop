...
use canvas_core::{
    cover_transform, uncrop_transform, LayerContent, LayerId, SetCrop, SetPageSize, SetTransform,
    Transform,
};
use eframe::egui;
...
pub use canvas_view::{canvas_ui, CanvasAction};
...
pub(super) fn size_popup_ui(state: &mut EditorState, ctx: &egui::Context) {
